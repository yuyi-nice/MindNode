...
MoltyBox 是一个面向 AI 智能体的云平台和硬件一体化解决方案提供商。产品定位为「AI 智能体装配线」，提供从模型、技能到硬件的完整基础设施。
...
|-----|---------|------|---------|-----|
| 1 | 首页 | `/` | Home.jsx | ✅ |
| 2 | MoltyBox 产品页 | `/moltybox` | MoltyBox.jsx | ✅ |
...
**顶部导航栏**：
- Logo（返回首页）
- 主导航：MoltyBox、技能库、盒子、模型、合伙人、推荐官计划
